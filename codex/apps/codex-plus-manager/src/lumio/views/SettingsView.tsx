...
type SettingsSection = "account" | "codex" | "claude" | "general" | "support";

const SETTINGS_SECTIONS: Array<{ id: SettingsSection; label: string }> = [
  { id: "account", label: "账户" },
  { id: "codex", label: shellLabels.codex },
  { id: "claude", label: shellLabels.claude },
  { id: "general", label: "通用" },
  { id: "support", label: "支持" },
];
...
export function SettingsView({
  ...
  return (
    <section className="lumio-settings-page">
      <aside className="lumio-settings-side" role="tablist" aria-label="设置分组">
