...
export const PLATFORMS: Array<{ id: PlatformId; title: string; requirement: string }> = [
  { id: "mac-arm", title: "Mac · Apple 芯片", requirement: "macOS 13 或更新版本" },
  { id: "mac-intel", title: "Mac · Intel", requirement: "macOS 13 或更新版本" },
  { id: "windows", title: "Windows", requirement: "Windows 10 / 11 · 64 位" },
];
