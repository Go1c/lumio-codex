...
- `origin`：`https://github.com/LumioGames/lumio-codex.git`。持续集成分支为 **`publish`**（发版与内部 CI 主线）。
...
- **部署 / 打包 / Release 步骤**不在本文展开，一律以 [`codex/docs/ops/`](../../../codex/docs/ops/README.md) 为准（知识索引见 [`ops-release.md`](./ops-release.md)）。
